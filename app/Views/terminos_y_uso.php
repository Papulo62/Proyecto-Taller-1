  ...
  <div class="d-flex justify-content-start px-3" style="width: 100%;">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Términos y condiciones de uso</li>
      </ol>
    </nav>
  </div>
  ...
  <ol class="d-flex flex-column gap-5">
    <li class="d-flex flex-column gap-3">
      ...
      <p>
        ...
        presentes Términos y Condiciones (en adelante, los "Términos y Condiciones").
        Si no está de acuerdo con alguno de los términos aquí establecidos, no debe utilizar el Sitio Web ni realizar
        compras en él.
    ...
    <li class="d-flex flex-column gap-3">
      ...
      <ol>
        <li>
          ...
          <p>
            El Usuario podrá navegar por el Sitio Web y seleccionar los Productos que desee adquirir, añadiéndolos
            al
            "Carrito de Compras".
          </p>
        </li>
        <li>
          ...
          <p>
            Antes de confirmar la compra, el Usuario podrá revisar el contenido de su Carrito de Compras, incluyendo
        ...
        <li>
          ...
          <p>
            Para completar la compra, el Usuario deberá proporcionar la información personal requerida, incluyendo
            nombre completo, dirección de envío, dirección de facturación (si es diferente), número de teléfono y
            dirección de correo electrónico. El Usuario declara que toda la información proporcionada es veraz y
            precisa.
          </p>
        </li>
        <li>
        ...
        <li>
          ...
          <p>
            Una vez completada la información y seleccionada la forma de pago, el Usuario deberá confirmar su
            pedido.
        ...
        <li>
          ...
          <p>
            ...
            del
            pago.
            En caso de rechazo, se informará al Usuario a la brevedad y se procederá al reembolso del importe pagado
            (si corresponde).
          </p>
        </li>
      </ol>
    ...
    <li class="d-flex flex-column gap-3">
      <h2 class="">Precios y Pagos</h2>
      <ol>
        <li>
          <h3>Precios</h3>
          <p>
            Los precios de los Productos se encuentran expresados en [Moneda local, por ejemplo: Pesos Argentinos
            (ARS)] e incluyen el Impuesto al Valor Agregado (IVA), a menos que se indique lo contrario.
            Los precios no incluyen los costos de envío, los cuales se detallarán por separado antes de la
    ...
    <li class="d-flex flex-column gap-3">
      ...
      <ol>
        ...
        <li>
          ...
          <p>
            Los plazos de entrega estimados se informarán al Usuario durante el proceso de compra y podrán variar
            según el destino y la disponibilidad del Producto.
        ...
        <li>
          ...
          <p>
            Los costos de envío serán a cargo del Usuario y se calcularán en función del destino, peso y volumen del
            pedido.
        ...
        <li>
          ...
          <p>
            ...
            Es responsabilidad del Usuario asegurarse de que la dirección sea correcta y de que haya alguien
            disponible para recibir el pedido.
          </p>
        </li>
        <li>
          <h3>Demoras</h3>
    ...
    <li class="d-flex flex-column gap-3">
      <h2 class="">Garantía de Productos</h2>
      <p>
        Los Productos comercializados por [Nombre de tu Tienda Online] cuentan con la garantía legal por defectos de
        fabricación, de acuerdo con lo establecido en la Ley de Defensa del Consumidor.
    ...
    <li class="d-flex flex-column gap-3">
      ...
      <p>
        ...
        [Nombre
        de tu Empresa/Nombre del Propietario].
      </p>
    </li>
    ...
    <li class="d-flex flex-column gap-3">
      ...
      <p>
        ...
        etc.), siempre y cuando el Usuario haya otorgado su consentimiento para ello.
    ...
    <li class="d-flex flex-column gap-3">
      ...
      <p>
        ...
        El uso continuado del Sitio Web y la realización de compras después de la publicación de modificaciones
        constituirá la aceptación de los nuevos Términos y Condiciones.
      </p>
    </li>

    <li class="d-flex flex-column gap-3">
      <h2 class="">Ley Aplicable y Jurisdicción</h2>
      <p>
