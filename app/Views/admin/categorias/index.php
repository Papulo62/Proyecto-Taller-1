...
<section class="container-xl mt-5">
  <h1 class="fw-bold text-center display-4 mb-4">Categoria</h1>
  <div class="d-flex justify-content-end mb-5">
    <a href="<?php echo base_url('admin/categorias/nuevo'); ?>"><button class="btn-base" type="button">Agregar
        Categoria</button></a>
  </div>
  <table class="table my-3">
    ...
    <?php foreach ($categorias as $categoria): ?>
      <tr class="container-fluid">
        ...
        <td>
          <a href="<?= base_url('admin/categorias/edita/' . $categoria['id']); ?>"><button
          ...
          <button type="button" class="btn btn-danger btn-md " data-bs-toggle="modal" data-bs-target="#eliminaModal"
            data-bs-url="<?= base_url('admin/categorias/' . $categoria['id']); ?>">Eliminar</button>
        </td>
        </td>
      </tr>
